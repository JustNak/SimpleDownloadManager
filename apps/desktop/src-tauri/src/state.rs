...
const BULK_HOSTER_FINISH_PROTECTION_REMAINING_BYTES: u64 = 64 * 1024 * 1024;
const BULK_HOSTER_FINISH_PROTECTION_MIN_TOTAL_BYTES: u64 = 512 * 1024 * 1024;
const BULK_HOSTER_FINISH_PROTECTION_ETA: u64 = 30;
