...
assert.equal(normalizeHostInput('sub.example.com:8443/path?q=1'), 'sub.example.com:8443');
...
assert.deepEqual(added.hosts, ['example.com', 'cdn.example.com', 'mirror.example.org']);
assert.deepEqual(added.addedHosts, ['cdn.example.com', 'mirror.example.org']);
assert.deepEqual(added.duplicateHosts, ['example.com']);

assert.deepEqual(removeExcludedHost(added.hosts, 'cdn.example.com'), ['example.com', 'mirror.example.org']);
